...
def generate_linestxt_on_curvelane_val():
    ...
    curRoot = "/home/wukong/Desktop/LaneDetection/EdgeDetectSet"
    curvelane_val_root = os.path.join(curRoot, 'valid')
    ...
    for file in tqdm.tqdm(all_files):
        ...
        culane_style_label = read_label(label_path, x_factor = 1920 / width, y_factor = 1080 / height)
